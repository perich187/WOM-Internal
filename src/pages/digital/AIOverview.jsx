...
import { Sparkles, Globe, Loader2, Info } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5">
      <div>
        ...
        <p className="text-sm text-[#092137]/50">AI-powered SEO analysis and recommendations</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-[#EDE8DC] p-5">
        <div className="flex gap-3">
          <div className="relative flex-1">
            ...
            <input value={url} onChange={e => setUrl(e.target.value)} placeholder="Enter URL or domain to analyse" className="w-full pl-9 pr-4 py-2.5 text-sm border border-[#EDE8DC] rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400" />
          </div>
      ...
      <div className="bg-white rounded-xl border border-[#EDE8DC] overflow-hidden">
        <div className="px-5 py-3.5 border-b border-[#EDE8DC] flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-[#092137]">AI Analysis — wordofmouthagency.com.au</p>
